...
Outlining the prerequisites and step-by-step installation of the open-source help desk ticketing system osTicket in a cloud-based environment using Microsoft Azure.<br />



<h2>Video Demonstration</h2>

- ### [YouTube: Ticketing System Tutorial Part 1: osTicket - Prerequisites and Installation]()
...
<b>Step 8 </b>
<p>
Choose Standard Configuration, then next. Then choose "Install As Window Service" , then click next. Follow by putting this login information in the setup: new root password:  REDACTED ; confirm: root. Then click next, then execute. 
...
<p >
Continue Setting up osTicket in the browser. MySQL Database: osTicket ; MySQL Username: root ; MySQL Password:  REDACTED ; Click “Install Now!”
